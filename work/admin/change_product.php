...
<title>Admin Panel - Change Products</title>
</head>
...
<?php
		...
		switch($i){
			...
			default:echo "";
				...
				<td align="center"><a href="edit_product.php?id='.$pro_id.'">'.$pro_title.'</a><br><img id="disp_image" src="product_images/'.$pro_image.'" class="img-rounded" height="80" width="80" alt="'.$pro_image.'"></td>
