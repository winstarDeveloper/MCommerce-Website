...
<?php
		...
		switch($i){
			...
			default:echo "";
				...
				<table class="table table-striped table-bordered table-hover table-condensed" border="1px" width="338pxauto" align="center" style="margin:10px;">
				<thead>	<tr class="success">
				<td width="70px">Product ID</td>	
				...
				<td align="center"><form action="available_products.php" method="post" name="remove"><input name="rem" type="hidden" value="'.$pro_id.'" /><input name="deleteBtn" type="submit" class="btn btn-danger" value="X" style="margin:5px;"/></form></td>
			 </tr>';
			} 
